...
for (( i = 0; i < 2; i++ )); do
	ssh ${PARTITION[i]} '/home/lacp/lacp-cloud-experiments/SH/./sys_info_collect.sh'
done
...
#scp -r $HOME/lacp-cloud-experiments ONE2:/home/lacp
#scp -r $HOME/lacp-cloud-experiments ONE3:/home/lacp
scp -r $HOME/lacp-cloud-experiments ONE4:/home/lacp
